...
class Settings {
    public function __construct() {
        ...
        $this->host = 'bwxrvggd3zh8mfnbgzcd-mysql.services.clever-cloud.com';
        $this->port = 21578;

        $this->database = 'bwxrvggd3zh8mfnbgzcd';

        $this->username = 'u7zcp8wkpdov7huj';
        $this->password = '1l93onKmuWi6DIG17ab';
